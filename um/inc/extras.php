 ...
 * @return array
 */
function um_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'um_page_menu_args' );
 ...
 * @return array
 */
function um_body_classes( $classes ) {
...
add_filter( 'body_class', 'um_body_classes' );
